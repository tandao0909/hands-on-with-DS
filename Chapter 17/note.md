...
These problems have kept researchers very busy since 2014: many papers have been published on this topic, some proposing new cost functions (see this [GitHub repo]() for a nice comparison), though a [2018 paper]() by Google researchers judge their efficiency, or techniques to stabilize training or avoid the mode collapse issue. 
